...
def save_mesh(latent_vector, mesh_filename):
    ...
    specs_filename = "/hdd2/chenyang/shapo/test_data/sdf_rgb_pretrained/specs.json"
    model_params_subdir = "ModelParameters"
    checkpoint = "2000"
    sdf_latent_code_dir = "/hdd2/chenyang/shapo/test_data/sdf_rgb_pretrained"
    ...
    decoder = decoder.module.cuda('cuda:3')
    decoder.eval()

    offset = None
    scale = None

    latent_vector = torch.from_numpy(latent_vector).cuda('cuda:3')
