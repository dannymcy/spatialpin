...
def obstacle_generator(obstacles):
    ...
    for i, obstacle in enumerate(obstacles):
        # obstacle_id = uuid.uuid4()
        # Change obstacle_id to i here works in the new blender implementation for unknown reason, seems like need to be an integer
        # https://rtree.readthedocs.io/en/latest/class.html#rtree.index.Index
        obstacle_data.append((i, obstacle, obstacle))
