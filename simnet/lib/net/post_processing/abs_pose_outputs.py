...
class OBBOutput:
  ...
  def compute_loss(self, obb_targets, log, prefix):
    ...
    if obb_targets[0].appearance_emb is not None:
      ...
      appearance_emb_target = appearance_emb_target.to(torch.device('cuda:3'))
    ...
    if obb_targets[0].abs_pose_field is not None:
      ...
      abs_pose_target = abs_pose_target.to(torch.device('cuda:3'))
