...
if __name__ == '__main__':
    ...
    """After run LaMa for inpainting"""
    inpainted_obj_finding_lang_sam(hparams.data_dir, str(lang_sam_output_dir))
    blur_background(hparams.data_dir, lang_sam_output_dir)

    conversation_hist = None
    task_proposal_gpt4(hparams.data_dir, lang_sam_output_dir, conversation_hist, temperature_dict, model_dict, start_over=True)
    
    # Put your api key here
    git_token = ""
    git_repo = ""
    api_key = ""  # One-2-3-45++ for single-view object reconstruction
    generate_3d_model(hparams.data_dir, lang_sam_output_dir, git_token, git_repo, api_key)
